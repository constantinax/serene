            ...
            initial_tasks = [
               # 1. ΑΝΑΠΝΟΗ
                models.Task(
                    ...
                    is_favorite=False,
                    details="""Η αναπνοή 4-4-4, ή αλλιώς Αναπνοή σε Κουτί, είναι μια απλή τεχνική ανακούφισης του στρες. Σταθεροποιεί την ρηχή και γρήγορη αναπνοή που προκαλείται από το άγχος και ενεργοποιεί το παρασυμπαθητικό νευρικό σύστημα για να επαναφέρει το σώμα στο παρόν.
...
4. Μείνε σε αυτή τη θέση μέχρι να νιώσεις τους παλμούς σου να ηρεμούν."""
                ...
                models.Task(
                    ...
                    description="Επανάληψη φράσεων για οραματισμό και θετικές σκέψεις.",
                    duration="1 λεπτά",
                    category="home, outdoor",
                    is_favorite=False,
                    details="""Οι θετικές δηλώσεις είναι σύντομες προτάσεις που αντικαθιστούν τις αρνητικές σκέψεις και επαναπρογραμματίζουν τον τρόπο που αντιλαμβάνεσε τον εαυτό σου. 

Οδηγίες:
1.Επέλεξε τρεις φράσεις που σχετίζονται με αυτό που σε απασχολεί και σου δημιουργούν αίσθηση ηρεμίας.
2.Πές τις δηλώσεις δυνατά και προσπάθησε να νιώσεις την αλήθεια των λέξεων όσο τις προφέρεις.
"""
                ),
                ...
                models.Task(
                    ...
                    category="home, outdoor",
                    is_favorite=False,
                    details="""Το Jin Shin Jyutsu είναι μια τεχνική που βασίζεται στην ιδέα ότι κάθε δάχτυλο συνδέεται με ένα συναίσθημα.

Οδηγίες:
1.Πιάστε τον αντίχειρα σας με την παλάμη του άλλου χεριού .
2.Θα ξέρετε ότι λειτουργεί όταν νιώσετε έναν σταθερό, ρυθμικό παλμό στο δάχτυλο.
3.Προχωρήστε στο επόμενο δάχτυλο.
4.Κάντε και τα πέντε διαδοχικά.

Τα Δάχτυλα και τα Συναισθήματα:
• Αντίχειρας: Σταματά την ανησυχία και την υπερβολική σκέψη.
• Δείκτης: Διώχνει τον φόβο και τον πανικό.
• Μέσος: Μαλακώνει τον εκνευρισμό και την εσωτερική ένταση.
• Παράμεσος: Απελευθερώνει τη θλίψη και το σφίξιμο.
• Μικρό Δάχτυλο: Σταματά την υπερπροσπάθεια και το στρες των κοινωνικών προσδοκιών."""
                ),
                ...
                models.Task(
                    ...
                    category="home",
                    is_favorite=False,
                    details="""Ένας αφηγητής σε καθοδηγεί σε ασκήσεις αναπνοής και οραματισμού. Αν το να κάθεσαι ήσυχα με τις σκέψεις σου σου φαίνεται τρομακτικό, ο καθοδηγούμενος διαλογισμός μπορεί να είναι εξαιρετικό σημείο για να ξεκινήσεις. Βοηθά στη συγκέντρωση και την διαχείριση των διάσπαρτων αγχωτικών σκέψεων.

Οδηγίες: Απλά κάθισε σε ένα ήρεμο και αναπαυτικό μέρος και ακολούθα τις οδηγίες του αφηγητή."""
                ),
                ...
                models.Task(
                    ...
                    category="home, outdoor",
                    is_favorite=False,
                    details="""Η μουσική με αργό τέμπο μπορεί να συγχρονίσει τους καρδιακούς παλμούς με τον ρυθμό της, προκαλώντας φυσική επιβράδυνση της αναπνοής και ρύθμιση του νευρικού συστήματος.

Οδηγίες:
• Χρησιμοποίησε ακουστικά για καλύτερη απομόνωση.
• Κλείσε τα μάτια και συγκεντρώσου στους ήχους.  
• Άφησε τη μελωδία να σε παρασύρει."""
                ),
...
Οδηγίες:
1. Εισέπνευσε και σφύξε την μυϊκή ομάδα του σώματος σου που εμφανίζεται στην οθόνη.
2. Εξέπνευσε αργά και χαλάρωσε πλήρως τους μύες σου. Δώσε προσοχή στην αίσθηση που προκαλεί αυτή η διαφορά έντασης.
3. Συνέχισε στις υπόλοιπες μυικές ομάδες."""
                ),
                ...
                models.Task(
                    ...
                    category="home",
                    is_favorite=False,
                    details="""Το EFT (Emotional Freedom Technique) ή «Tapping» είναι μία τεχνική που χτυπάς ελαφρά συγκεκριμένα σημεία του σώματος (βελονιστικά σημεία) για να «ξεμπλοκάρεις» το κέντρο του εγκεφάλου σου που ελέγχει το άγχος και τον φόβο .

Οδηγίες:
Χρησιμοποίησε τις ακρες των δαχτύλων σου για να κάνεις ελαφρά, ρυθμικά χτυπήματα (tapping) περίπου 5-7 φορές σε κάθε σημείο που εμφανίζεται στην οθόνη, ενώ επικεντρώνεσαι στη σκέψη που σε αγχώνει.

Τα Σημεία:
• Κορυφή του κεφαλιού: Πνευματική διαύγεια.
...
• Μασχάλη: Απελευθέρωση ανασφάλειας."""
                )
            ]
...
async def signup(user: dict, db: Session = Depends(database.get_db)):
    # Λήψη στοιχείων από το JSON request
    ...
    if not email or not password:
        raise HTTPException(
            ...
            detail="Συμπληρώστε όλα τα πεδία"
        )
    ...
    if existing_user:
        raise HTTPException(
            status_code=status.HTTP_400_BAD_REQUEST, 
            detail="Το email ή το όνομα χρήστη χρησιμοποιείται ήδη"
        )

    # Δημιουργία και αποθήκευση νέου χρήστη
    new_user = models.User(username=email, email=email, password=password)
    db.add(new_user)
    db.commit()
    db.refresh(new_user)
...
async def login(request: dict, db: Session = Depends(database.get_db)):
    ...
    # Έλεγχος ύπαρξης χρήστη και ταύτισης κωδικού
    if not user or user.password != password:
        raise HTTPException(
            status_code=status.HTTP_401_UNAUTHORIZED, 
            detail="Λάθος στοιχεία ή ο χρήστης δεν υπάρχει"
        )
